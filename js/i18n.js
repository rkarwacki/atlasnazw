...
const TRANSLATIONS = {
  pl: {
    ...
    showNamesLabel: "Pokaż nazwy miejscowości na mapie",
    showNamesHintAvailable: "Widoczne, gdy liczba widocznych miejscowości jest mniejsza niż 250, lub przy dostatecznie dużym przybliżeniu mapy.",
    showNamesHintTooMany: "Przybliż mapę lub zawęź reguły/filtry poniżej 250 wyników, aby pokazać nazwy (obecnie: {count}).",
  ...
  en: {
    ...
    showNamesLabel: "Show town names on the map",
    showNamesHintAvailable: "Shown when fewer than 250 towns are visible, or when zoomed in close enough.",
    showNamesHintTooMany: "Zoom in closer, or narrow your rules/filters to fewer than 250 results, to show names (currently: {count}).",
    shareHeading: "Share",
